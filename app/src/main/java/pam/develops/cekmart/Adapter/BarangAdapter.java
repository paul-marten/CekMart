...
/**
 * Created by paulms on 5/16/2016.
 */
public class BarangAdapter extends ArrayAdapter<Barang> {
    ...
    public BarangAdapter(Context context, ArrayList<Barang> barangs) {
        super(context, R.layout.singleitem_list_barang, barangs);
...
//        imgLoader = ImageLoader.getInstance();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.singleitem_list_barang, parent,false);
            viewHolder.gambar = (ImageView)convertView.findViewById(R.id.itemlist_gambar_barang);
...
//        Picasso.with(context).load(url).into(viewHolder.gambar);
        ...
        Picasso.with(context).load(RESTClient.getURL_ResepMakananAPI() + barang.getUrl()).into(viewHolder.gambar);
        return convertView;
    }
}
